...
const generateDisposableEmail = (enabledEmailProviders = null) => {
...
export const generateIdentity = async (enabledProviders = null, sex = null, enabledEmailProviders = null, useRealAddresses = true) => {
...
export const generateIdentities = async (count = 4, enabledProviders = null, sex = null, enabledEmailProviders = null, useRealAddresses = true) => {
  return Promise.all(Array(count).fill().map(() => generateIdentity(enabledProviders, sex, enabledEmailProviders, useRealAddresses)));
}; 