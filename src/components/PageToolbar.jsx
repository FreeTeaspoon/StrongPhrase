...
const PageToolbar = ({
  ...
  const mobileButton = !alwaysShowChildren && hasChildren && (
  ...
  const desktopContent = (
    <div className={`${alwaysShowChildren ? 'flex' : 'hidden md:flex'} md:flex-row gap-3 items-start md:items-end w-full`}>
      {children}
    </div>
  );
