...
export const selectStrongphraseBits = (targetMinimumBits) => {
...
export const calculateWordsNeeded = (systemId, desiredBits) => {
...
export const calculateActualEntropy = (systemId, numWords) => {
  const system = getSystemById(systemId);
  if (!system) return null;
...
export const generatePassphraseData = (minEntropyBits, getRandomWordsFn) => {
